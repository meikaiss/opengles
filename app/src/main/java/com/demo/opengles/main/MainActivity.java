...
import com.demo.opengles.record.camera2.glrecorddouble.Camera2GLSurfaceView4RecordActivity2;
    ...
    private List<MainItemBean> dataList = new ArrayList<MainItemBean>() {
        {
            ...
            add(new MainItemBean("Camera2-GLSurfaceView-双份录制", Camera2GLSurfaceView4RecordActivity2.class, Manifest.permission.CAMERA,
