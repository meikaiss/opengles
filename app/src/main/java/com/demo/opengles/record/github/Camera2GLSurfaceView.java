...
//        mDrawer = new CameraDrawer();
        cameraRenderObject = new CameraRenderObject(getContext());
        ...
        cameraRenderObject.inputWidth = mCameraProxy.mPreviewSize.getWidth();
        cameraRenderObject.inputHeight = mCameraProxy.mPreviewSize.getHeight();
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        cameraRenderObject.onDraw(mTextureId);
