...
public class Camera1GLSurfaceViewTakePhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera1_glsurface_takephoto);
        ...
        render = new VideoRender();
        {
            ...
            renderObject.onTakePictureListener = new OnTakePictureListener() {
                @Override
                public void onTakePicture(Bitmap bitmap) {
                    getWindow().getDecorView().post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Log.e(TAG, "拍照图片的宽高=" + bitmap.getWidth() + " , " + bitmap.getHeight());
                        }
                    });
                }
            };
        ...
        findViewById(R.id.btn_take_picture).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                render.renderObjectList.get(0).needTakePicture = true;
            }
        });
    }
    ...
    private void initCamera1(SurfaceTexture surfaceTexture, Surface surface) throws Exception {
        ...
        CollectUtil.execute(parameters.getSupportedPictureSizes(),
                new CollectUtil.Executor<Camera.Size>() {
                    @Override
                    public void execute(Camera.Size size) {
                        Log.e(TAG,
                                "SupportedPictureSizes, width=" + size.width + ", height=" + size.height);
                    }
                });
    ...
    private interface OnTakePictureListener {
